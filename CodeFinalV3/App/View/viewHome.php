...
<body>
    <h1> MythicScans - Lecture de Mangas, Webtoons et Light Novels en ligne</h1>
    <header id="navbar">
        ...
        <button id="burger"><img src="./public/img/menu.svg" alt="menu" aria-label="Ouvrir le menu" />
        </button>
    </header>
    ...
    <main>
        ...
        <section id="genres">
            ...
            <article>
                <a href="#">
                    <img src="./public/img/Webtoon.svg" alt="Catégorie Webtoon avec une image de l'application webtoon">
                    <p>
                        Webtoon
                    </p>
                </a>
                ...
                <a href="#">
                    <img src="./public/img/Manga.svg" alt="Catégorie Manga avec une image de SNK ">
                    <p>
                        Manga
                    </p>
                </a>
                ...
                <a href="#">
                    <img src="./public/img/LN.svg" alt="Catégorie Light Novel avec une image de livre ouvert">
                    <p>
                        Light Novel
                    </p>
                </a>
                    ...
                    <div>
                        <?php if (!empty($series[$id_type])): ?>
                            <?php foreach ($series[$id_type] as $s): ?>
                                <figure>
                                    <a href="#">
                                        <img src="<?= htmlspecialchars($s->getCoverImage()) ?>"
                                            alt="<?= htmlspecialchars($s->getTitle()) ?>">
                                    </a>
